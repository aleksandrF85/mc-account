...
```
cd existing_repo
git remote add origin https://gitlab.skillbox.ru/javapro_team55/mc-account.git
git branch -M master
...
- [ ] [Set up project integrations](https://gitlab.skillbox.ru/javapro_team55/mc-account/-/settings/integrations)
